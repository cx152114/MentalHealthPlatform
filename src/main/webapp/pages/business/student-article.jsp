            ...
            <div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: #9FAFD1" class="div4">
                        <a href="#" onclick="getTargetArticle(12)"><strong style="font-size: 24px;">情感美文</strong></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: #a9d96c" class="div4">
                        <a href="#" onclick="getTargetArticle(13)"><strong style="font-size: 24px;">学业压力</strong></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: antiquewhite" class="div4">
                        <a href="#" onclick="getTargetArticle(14)"><strong style="font-size: 24px;">生活阻碍</strong></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: #8D8D8D" class="div4">
                        <a href="#" onclick="getTargetArticle(15)"><strong style="font-size: 24px;">日常交际</strong></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: red" class="div4">
                        <a href="#" onclick="getTargetArticle(16)"><strong style="font-size: 24px;">毕业焦虑</strong></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div style="width: 250px;height: 150px;border: #00a6b2 solid 1px;background: #4fd98b" class="div4">
                        <a href="#" onclick="getTargetArticle(17)"><strong style="font-size: 24px;">新生引导</strong></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="application/javascript">
    ...
    var dataTable = $('#articles').bootstrapTable({
        url: "/business/article/findTargetStudentArticle",                      //  请求后台的URL
        method: "post",                      //  请求方式
    ...
    function detailFormatter(index, row) {
        ...
        $.each(row, function (key, value) {
            if(key=="articleContent"){
                html.push("<div style='height:300px;overflow:auto'><b>文章内容：</b> " + value + "</div>")
            }
    ...
    function refreshTable(date) {
        dataTable.bootstrapTable('refresh', {
            url: "/business/article/findTargetStudentArticle/"+date,
            pageSize: 5,
            pageNumber: 1,
            typeId:date
        });
    ...
    function getTargetArticle(date){
        refreshTable(date)
        $("#content-type").hide()
        $("#content-area").show()
    }
