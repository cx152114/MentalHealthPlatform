...
<div class="panel panel-default" style="padding-left: 15px;">
    ...
    <div class="x_content" style="padding-left: 15px;padding-right: 15px;">
        <form class="form-horizontal" id="editResource" onsubmit="return false" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <input type="text" value=" ${parent.resourceName}" class="form-control" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-2" style="font-size:19px;margin-bottom: 3px;margin-left: 5px;text-align: right">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <input type="text" name="resourceName" value="${resource.resourceName}" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-2" style="font-size:19px;margin-bottom: 3px;margin-left: 5px;text-align: right">
...
<script>
    $(document).ready(function(){
        $("#editResource").submit(function(){
        $.ajax({
            url: '/sys/resource/update',
            type: 'post',
            data: $("#editResource").serialize(),
            dataType: 'json',
