...
<section id="container">
    ...
    <small class="font-bold"></small>
            ...
            <!-- 新增文章 -->
            <%--<div class="modal inmodal" id="addArticleModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content animated bounceInRight">
                        <div class="panel  form-panel "  style="margin:0 auto; width:100%; border:1px solid #F00; ">
                            <div class="panel-heading" style="text-align: center;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="mb" style="margin: 0px"> 新增文章信息</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal style-form" id="addArticleForm" action="/business/article/addArticle" method="post">
...
&lt;%&ndash;                                            <div>&ndash;%&gt;
&lt;%&ndash;                                                <label class="control-label" style="font-size:19px;margin-left: 5px;">备注</label>&ndash;%&gt;
&lt;%&ndash;                                                <input type="text" class="form-control" name="warehouseRemark" placeholder="备注" style="width: 60%">&ndash;%&gt;
&lt;%&ndash;                                            </div>&ndash;%&gt;
                                        </div>
                                    </div>
...
--%>
            ...
            <!-- 修改文章信息 -->
            <%--<div class="modal inmodal" id="alterArticleModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content animated bounceInRight">
                        <div class="panel  form-panel "  style="margin:0 auto; width:100%; border:1px solid #F00; ">
                            <div class="panel-heading" style="text-align: center;">

                                <h3 class="mb" style="margin: 0px">修改文章信息</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal style-form" action="/business/article/editArticle" method="post">
                                    <div class="form-group" >
                                        <div class="col-sm-10" >
